...
export function loadADRsFromIndex(filePath) {
    ...
    if (idIndex === -1 || statusIndex === -1 || hashIndex === -1) {
        throw new Error(`adr-index.md inválido: colunas obrigatórias "ID" e "Status" não encontradas`);
    }
    return tableLines
